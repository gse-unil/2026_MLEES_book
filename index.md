...
**Everything runs.** Most pages are live notebooks. You can read them here as rendered text and figures, or run them yourself by launching a page in google Colab using the badge icon at the top, or cloning the [repository](https://github.com/gse-unil/2026_MLEES_book) and run it locally. The best way to learn is to change a value, re-run, and see what happens.
...
:link: part-I/part-I
Programming foundations from zero, the numerical and data stack (`numpy`, `pandas`, `xarray`, `matplotlib`), plotting and maps, and reproducible workflows for gridded geoscientific data.
:::

:::{card} Part II — Basics of Machine Learning for Earth and Environmental Sciences
:link: part-II/part-II
Regression and classification, model evaluation, unsupervised methods, and the bridge from classical estimators to neural networks, each grounded in an environmental problem.
:::
...
The book is open. Fixing a typo or authoring a chapter — the contributor guide explains the workflow and conventions.
:::
...
[setup instructions](appendix/appendix.md) walk you through it. A little familiarity
...
## Authors
Tom Beucler, Milton Gomez, Frederick Iat-Hin Tam, Jingyan Yu, Saranya Ganesh S., Haokun Liu, Kejdi LLeshi, Shivanshi Ashtana, Ayoub Fatihi, Filippo Quarenghi# Machine Learning for Earth and Environmental Sciences
...
:::{card} How to contribute
:link: CONTRIBUTING.md
The book is open. Fixing a typo or authoring a chapter — the contributor guide explains the workflow and conventions. (# TODO: Check for GitHub restrictions)
:::
