...
Explaining why a model makes its predictions, quantifying how confident those predictions are with generative and probabilistic models, and combining machine learning with physics-based models, as in a hybrid glacier ice-flow simulation.
:::
